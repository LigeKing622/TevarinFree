...
public class RotationUtil {
    ...
    public static Vector2f calculate(final dev.tevarin.utils.vector.Vector3d from, final dev.tevarin.utils.vector.Vector3d to) {

        final dev.tevarin.utils.vector.Vector3d diff = to.subtract(from);
    ...
    public static Vector2f calculate(final Vec3 to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0, mc.thePlayer.getEyeHeight(), 0), new dev.tevarin.utils.vector.Vector3d(to.xCoord, to.yCoord, to.zCoord));
    }

    public static Vector2f calculate(final dev.tevarin.utils.vector.Vector3d to) {
        return calculate(mc.thePlayer.getCustomPositionVector().add(0, mc.thePlayer.getEyeHeight(), 0), to);
    }

    public static Vector2f calculate(final dev.tevarin.utils.vector.Vector3d position, final EnumFacing enumFacing) {
        ...
        return calculate(new dev.tevarin.utils.vector.Vector3d(x, y, z));
    }
